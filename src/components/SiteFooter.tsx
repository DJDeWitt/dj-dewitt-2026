      ...
      <div className="footer__container">
        <div className="footer__top">
          <div className="footer__brand">
            <a href="https://flowbite.com/" className="footer__brandLink">
              <img
                src="https://flowbite.com/docs/images/logo.svg"
                className="footer__logo"
                alt="FlowBite Logo"
              />
              <span className="footer__brandName">DJ DeWitt</span>
            </a>
          </div>
            ...
            <div className="footer__col">
              ...
              <ul className="footer__list">
                <li className="footer__listItem">
                  <a href="https://flowbite.com/" className="footer__link">
                    DJ DeWitt
                  </a>
                </li>
                <li className="footer__listItem">
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__social">
            <a href="#" className="footer__socialLink" aria-label="Facebook page">
              <svg
            ...
            <a
              href="#"
              className="footer__socialLink footer__socialLink--spaced"
